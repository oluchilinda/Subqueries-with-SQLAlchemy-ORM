# coding: utf-8
from sqlalchemy import CHAR, Column, DECIMAL, DateTime, Enum, ForeignKey, Index, Integer, LargeBinary, SmallInteger, String, TIMESTAMP, Table, Text, text
...
class Category(Base):
    ...
    category_id = Column(TINYINT, primary_key=True)
...
class Country(Base):
    ...
    country_id = Column(SMALLINT, primary_key=True)
...
class Language(Base):
    ...
    language_id = Column(TINYINT, primary_key=True)
...
class Staff(Base):
    ...
    staff_id = Column(TINYINT, primary_key=True)
    first_name = Column(String(45), nullable=False)
    ...
    store_id = Column(ForeignKey('store.store_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
...
class Store(Base):
    ...
    store_id = Column(TINYINT, primary_key=True)
...
class City(Base):
    ...
    city_id = Column(SMALLINT, primary_key=True)
    city = Column(String(50), nullable=False)
    country_id = Column(ForeignKey('country.country_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
    last_update = Column(TIMESTAMP, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"))
...
class Film(Base):
    ...
    original_language_id = Column(ForeignKey('language.language_id', ondelete='RESTRICT', onupdate='CASCADE'), index=True)
    rental_duration = Column(TINYINT, nullable=False, server_default=text("'3'"))
...
class Addres(Base):
    ...
    address_id = Column(SMALLINT, primary_key=True)
    address = Column(String(50), nullable=False)
    address2 = Column(String(50))
    district = Column(String(20), nullable=False)
    city_id = Column(ForeignKey('city.city_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
...
class FilmCategory(Base):
    ...
    category_id = Column(ForeignKey('category.category_id', ondelete='RESTRICT', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)
    last_update = Column(TIMESTAMP, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"))
...
class Inventory(Base):
    ...
    inventory_id = Column(MEDIUMINT, primary_key=True)
    film_id = Column(ForeignKey('film.film_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
    store_id = Column(ForeignKey('store.store_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False)
    last_update = Column(TIMESTAMP, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"))
...
class Customer(Base):
    ...
    customer_id = Column(SMALLINT, primary_key=True)
    store_id = Column(ForeignKey('store.store_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
    first_name = Column(String(45), nullable=False)
    last_name = Column(String(45), nullable=False, index=True)
    email = Column(String(50))
...
class Payment(Base):
    ...
    payment_id = Column(SMALLINT, primary_key=True)
    customer_id = Column(ForeignKey('customer.customer_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
    staff_id = Column(ForeignKey('staff.staff_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
